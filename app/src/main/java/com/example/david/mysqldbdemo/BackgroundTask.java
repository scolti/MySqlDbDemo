package com.example.david.mysqldbdemo;
...
/**
 * Created by David on 29/08/2016.
 */
public class BackgroundTask extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... params) {
        ...
        String reg_url = "http://informesapp.esy.es/webapp/register.php";
        String login_url = "http://informesapp.esy.es/webapp/login.php";
